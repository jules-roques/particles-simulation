...
private:
    ...
    * @param depth 
    */
   void createInternCellsRecursive(std::vector<int>& coordinates,
                                   int depth);
    ...
    * @param depth 
    */
   void createExternCellsRecursive(std::vector<int>& coordinates,
                                   int depth);
...
public:
    ...
    *        Before simulation, fill cells with particles
    * @param timeStep
