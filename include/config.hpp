 ...
 * @brief Enables the display of progress information during the program's
 * execution.
 *
 * When defined, this directive allows the program to output information about
 * its progress, which can be useful for monitoring and debugging long-running
 * tasks.
 */
 ...
 *
 * When defined, this directive allows the program to write its output in PNG
 * format. This is useful for generating visual representations of the
 * simulation data.
 */
#define PNG_OUTPUT
 ...
 *
 * When defined, this directive allows the program to write its output in XML
 * format. This can be useful for exporting data in a structured and widely-used
 * format for further processing or analysis. Uncomment this line to enable this
 * behavior.
 */
// #define XML_OUTPUT
